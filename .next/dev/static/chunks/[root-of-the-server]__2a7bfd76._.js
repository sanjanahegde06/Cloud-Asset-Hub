...
function Profile() {
    ...
    const [totalBytes, setTotalBytes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [totalFiles, setTotalFiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    // Ensure quota is a proper number
    const quotaBytes = Number(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_USER_QUOTA_BYTES) || 1024 * 1024 * 1024 // 1 GB default
    ;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Profile.useEffect": ()=>{
            let mounted = true;
            async function load() {
                ...
                try {
                    ...
                    let allFiles = [];
                    while(true){
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('uploads').list(currentUser.id, {
                            limit: pageSize,
                            offset
                        });
                    ...
                    const bytes = allFiles.reduce({
                        "Profile.useEffect.load.bytes": (acc, f)=>{
                            const size = Number(f.size || f.metadata?.size || 0);
                            return acc + (isNaN(size) ? 0 : size);
                        }
                    }["Profile.useEffect.load.bytes"], 0);
...
_s(Profile, "A0oDk5B/lkUAk/gOa5r6bubD4GY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a7bfd76._.js.map